...
exports['default'] = function (context) {
  ...
  if (errors.length == 0) {
    Shared.showMessage_inContext(_Error.Error.unsupportedElement.message, context);
  } else {
...
function getSelectionAndOptions_forAngleInstances(options) {
  ...
  var otherArtboards = options.otherArtboards;
  var alertImage = options.alertImage;
